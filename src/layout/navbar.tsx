  ...
  return (
    <header
      className={classNames(
        "sticky top-0 z-50 mt-2 px-6 py-8 transition-transform duration-300 ease-out sm:mt-8 sm:px-14 md:px-20",
              ...
              return (
                ...
                >
                  <Link
                    href={_link.href}
                    className={classNames(
                      currentPath === _link.href ||
                        (currentPath === "/" && _link.href === "/#home")
